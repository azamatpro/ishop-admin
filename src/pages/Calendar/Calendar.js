...
import { Row, Col, Card, CardBody, Button, Modal, ModalHeader, ModalBody, Container } from 'reactstrap';
...
import { getEvents, addNewEvent, updateEvent, deleteEvent, getCategories } from '../../store/actions';
              ...
              <Col xl={9}>
                <Card className='mb-0'>
                  <CardBody>
                    ...
                    <Modal isOpen={this.state.modal} className={this.props.className} id='event-modal'>
                          ...
                          <Row>
                            <Col>
                              <div className='text-end'>
                                <button type='button' className='btn btn-light me-2' onClick={this.toggle}>
                                  Close
                                </button>
                                {!!isEdit && (
                                  <button
