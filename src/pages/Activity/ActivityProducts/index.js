...
class EcommerceProducts extends Component {
  ...
  onFilterProducts = (value, checked) => {
    ...
    if (!!checked && parseInt(value) === 0) {
      ...
      filteredProducts = productsData.filter((product) => product.offer >= Math.min(...discount));
    }
  ...
  onUpdate = (render, handle, value) => {
    this.setState({
      products: productsData.filter((product) => product.newPrice >= value[0] && product.newPrice <= value[1]),
    });
  };
                ...
                <Card>
                    ...
                    <div className='accordion ecommerce' id='accordionExample'>
                      <div className='accordion-item'>
                        <h2 className='accordion-header' id='headingOne'>
                          ...
                          >
                            <i className='mdi mdi-desktop-classic font-size-16 align-middle me-2'></i> Electronic
                          </button>
                        </h2>
                        <Collapse isOpen={this.state.isCategoryOpen1} className='accordion-collapse'>
                      ...
                      <div className='accordion-item'>
                        <h2 className='accordion-header' id='headingtwo'>
                          <button
                            ...
                            data-bs-toggle='collapse'
                          >
                            <i className='mdi mdi-hanger font-size-16 align-middle me-2'></i> Fashion
                          </button>
                        </h2>
                        <Collapse isOpen={this.state.isCategoryOpen2} className='accordion-collapse'>
                          <div className='accordion-body'>
                            <ul className='list-unstyled categories-list mb-0'>
                              <li className='active'>
                                <Link to='#'>
                      ...
                      <div className='accordion-item'>
                        <h2 className='accordion-header' id='headingThree'>
                          <button
                            ...
                            data-bs-toggle='collapse'
                          >
                            <i className='mdi mdi-pinwheel-outline font-size-16 align-middle me-2'></i> Baby & Kids
                          </button>
                        </h2>
                        <Collapse isOpen={this.state.isCategoryOpen3} className='accordion-collapse'>
                          <div className='accordion-body'>
                            <ul className='list-unstyled categories-list mb-0'>
                              <li>
                                <Link to='#'>
                      ...
                      <div className='accordion-item'>
                        <h2 className='accordion-header' id='headingThree'>
                          <button
                            ...
                            data-bs-toggle='collapse'
                          >
                            <i className='mdi mdi-dumbbell font-size-16 align-middle me-2'></i> Fitness
                          </button>
                        </h2>

                        <Collapse isOpen={this.state.isCategoryOpen4} className='accordion-collapse'>
                          <div className='accordion-body'>
                            <ul className='list-unstyled categories-list mb-0'>
                              <li>
                                <Link to='#'>
                                  <i className='mdi mdi-circle-medium me-1'></i> Gym equipment
                                </Link>
                              </li>
                              <li>
                                <Link to='#'>
                                  <i className='mdi mdi-circle-medium me-1'></i> Yoga mat
                                </Link>
                              </li>
                              <li>
                                <Link to='#'>
                                  <i className='mdi mdi-circle-medium me-1'></i> Dumbbells
                                </Link>
                              </li>
                              <li>
                                <Link to='#'>
                                  <i className='mdi mdi-circle-medium me-1'></i> Protein supplements
                                </Link>
                              </li>
                            </ul>
                          </div>
                  ...
                  <div className='custom-accordion'>
                      ...
                      <div>
                        <h5 className='font-size-14 mb-0'>
                          <Link
                            ...
                            data-bs-toggle='collapse'
                          >
                            Discount <i className='mdi mdi-minus float-end accor-plus-icon'></i>
                          </Link>
                        </h5>
                        <Collapse isOpen={this.isFilterProductDiscountOpen} id='filterprodductcolor-collapse'>
                          <div className='mt-4'>
                            {discountData.map((discount, i) => (
                              <div className='form-check mt-2' key={'_discount_' + i}>
                                <Input
                                  type='checkbox'
                      ...
                      <div>
                        <h5 className='font-size-14 mb-0'>
                          <Link
                            ...
                            className='text-dark d-block'
                            data-bs-toggle='collapse'
                            onClick={this.filtersizetoggle}
                          >
                            Size <i className='mdi mdi-minus float-end accor-plus-icon'></i>
                          </Link>
                        </h5>
                    ...
                    <CardBody className='border-top'>
                      <div>
                        <h5 className='font-size-14 mb-0'>
                          <Link to='#' onClick={this.filterratingtoggle} className='collapsed text-dark d-block'>
                            Customer Rating <i className='mdi mdi-minus float-end accor-plus-icon'></i>
                          </Link>
                        </h5>
                        <Collapse
                        ...
                        >
                          <div className='mt-4'>
                            ...
                            <div className='form-check mt-2'>
                              ...
                              />
                              <Label className='form-check-label' htmlFor='productratingCheck2'>
                            ...
                            <div className='form-check mt-2'>
                              ...
                              />
                              <Label className='form-check-label' htmlFor='productratingCheck3'>
                            ...
                            <div className='form-check mt-2'>
                              ...
                              />
                              <Label className='form-check-label' htmlFor='productratingCheck4'>
                          ...
                          products.map((product, key) => (
                            <Col xl='4' sm='6' key={'_col_' + key}>
                              <div
                                ...
                                onClick={() => history.push(`/ecommerce-product-detail/${product.id}`)}
                              >
                                <div className='product-img'>
                                  {product.islable ? (
                                    <div className='product-ribbon badge bg-warning'>{product.lable}</div>
                                  ) : null}
                                  {product.isOffer ? (
                                    <div className='product-ribbon badge bg-primary'>{`- ${product.offer} %`}</div>
                                  ) : null}
                                  <div className='product-like'>
                                    <Link to='#'>
                                      <i
                                        className={
                                          product.islike ? 'mdi mdi-heart text-danger' : 'mdi mdi-heart-outline'
                                        }
                                      ></i>
                                    </Link>
                                  </div>
                                ...
                                <div className='text-center'>
                                  <p className='font-size-12 mb-1'>{product.extrades}</p>
                          ...
                          <div className='float-sm-end'>
                            <Pagination className='pagination pagination-rounded mb-sm-0'>
                              <PaginationItem disabled={page === 1}>
                                <PaginationLink previous to='#' onClick={() => this.handlePageClick(page - 1)} />
                              </PaginationItem>
                              {map(Array(totalPage), (item, i) => (
                                <PaginationItem active={i + 1 === page} key={'_pagination_' + i}>
                                  <PaginationLink onClick={() => this.handlePageClick(i + 1)} to='#'>
                                    {i + 1}
                                  </PaginationLink>
                                </PaginationItem>
                              ))}
                              <PaginationItem disabled={page === totalPage}>
                                <PaginationLink next to='#' onClick={() => this.handlePageClick(page + 1)} />
                              </PaginationItem>
                            </Pagination>
                          </div>
                        </Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(EcommerceProducts));
