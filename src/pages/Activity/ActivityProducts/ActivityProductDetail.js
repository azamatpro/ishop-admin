    ...
    return (
      <React.Fragment>
        <div className='page-content'>
          <Container fluid>
            <Breadcrumbs title='Product Detail' breadcrumbItems={this.state.breadcrumbItems} />
                                    ...
                                    <NavItem>
                                      ...
                                      >
                                        <img
                                          ...
                                          alt=''
                                          onClick={() => {
                                            this.imageShow(product.extraimgs[0], 2);
                                          }}
                                          className='img-fluid mx-auto d-block tab-img rounded'
                                        />
                                      </NavLink>
                                    ...
                                    <NavItem>
                                      ...
                                      >
                                        <img
                                          ...
                                          alt=''
                                          onClick={() => {
                                            this.imageShow(product.extraimgs[1], 3);
                                          }}
                                          className='img-fluid mx-auto d-block tab-img rounded'
                                        />
                                      </NavLink>
                                    ...
                                    <NavItem>
                                      ...
                                      >
                                        <img
                                          ...
                                          alt=''
                                          onClick={() => {
                                            this.imageShow(product.extraimgs[2], 4);
                                          }}
                                          className='img-fluid mx-auto d-block tab-img rounded'
                                        />
                                      </NavLink>
                          ...
                          <Col xl='7'>
                            <div className='mt-4 mt-xl-3'>
                              ...
                              <div className='d-inline-flex'>
                                ...
                                <div className='text-muted'>( {product.reviews} )</div>
                              </div>

                              <h5 className='mt-2'>
                                <del className='text-muted me-2'>${product.oldprice}</del>${product.newprice}
                                {!!product.isOffer && (
                                  <span className='text-danger font-size-12 ms-2'>{product.offer} % Off</span>
                                )}
                              </h5>
                                  ...
                                  <ul className='list-unstyled product-desc-list'>
                                    {product.shortservices &&
                                      product.shortservices.map((item, i) => (
                                        <li key={i}>
                                          <i className={'mdi ' + item.icon + ' text-primary me-1 font-size-16'}></i>{' '}
                                          {item.value}
                                        </li>
                                      ))}
                                  </ul>
                                  ...
                                  <div className='product-color'>
                                    ...
                                    {product.colorOptions &&
                                      product.colorOptions.map((option, i) => (
                                        <Link to='#' className={i === 0 ? 'active' : ''} key={i}>
                          ...
                          <div className='product-desc'>
                            <Nav tabs className='nav-tabs-custom'>
                              <NavItem>
                                <NavLink
                                  className={classnames({
                                    active: this.state.activeDescriptionTab === 'description',
                                  })}
                                  onClick={() => {
                              ...
                              <NavItem>
                                <NavLink
                                  className={classnames({
                                    active: this.state.activeDescriptionTab === 'specifications',
                                  })}
                                  onClick={() => {
                            ...
                            <TabContent activeTab={this.state.activeDescriptionTab} className='border border-top-0 p-4'>
                              <TabPane tabId='description'>
                                <div>
                                  ...
                                  <p>
                                    ...
                                    more common several languages coalesce, the grammar of the resulting.
                                  </p>
                                  <p>It will be as simple as occidental in fact.</p>

                                  <div>
                                    <p className='mb-2'>
                                      <i className='mdi mdi-circle-medium me-1 align-middle'></i> If several languages
                                      coalesce
                                    </p>
                                    <p className='mb-2'>
                                      <i className='mdi mdi-circle-medium me-1 align-middle'></i> To an English person,
                                      it will seem like simplified
                                    </p>
                                    <p className='mb-0'>
                                      <i className='mdi mdi-circle-medium me-1 align-middle'></i> These cases are
                                      perfectly simple.
                                    </p>
                                  </div>
                                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(EcommerceProductDetail);
