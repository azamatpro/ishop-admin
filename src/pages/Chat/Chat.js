...
import { addMessage, getChats, getContacts, getGroups, getMessages } from '../../store/actions';
                ...
                <div className='p-3 border-bottom'>
                  <div className='d-flex'>
                    <div className='align-self-center me-3'>
                      <img src={user1} className='avatar-xs rounded-circle' alt='' />
                    </div>
                          ...
                          {chats.map((chat, key) => (
                            <li key={key} className={chat.isActive ? 'active' : ''}>
                              <Link
                                to='#'
                                onClick={() => {
                                  this.userChatOpen(chat.id, chat.name, chat.status, chat.roomId);
                                }}
                              >
                                <div className='d-flex'>
                                  <div
                        ...
                        <i
                          className={
                            this.state.Chat_Box_User_Status === 'online'
                              ...
                              : this.state.Chat_Box_User_Status === 'Intermediate'
                      ...
                      <ul className='list-inline user-chat-nav text-end mb-0'>
                        ...
                        <li className='list-inline-item'>
                          <Dropdown
                            ...
                            toggle={() => this.setState({ other2: !this.state.other2 })}
                          >
                            <DropdownToggle className='btn nav-btn ' tag='i'>
                          ...
                          >
                            <div className='conversation-list'>
                              ...
                              <div className='ctext-wrap'>
                                ...
                                <p className='chat-time mb-0'>{moment(message.createdAt).format('hh:mm')}</p>
                              </div>
                            </div>
                          </li>
                        ))}
                    ...
                    <Row>
                      ...
                      <Col xs={{ size: 'auto' }}>
                        <Button
                          type='button'
                          color='primary'
                          onClick={() => this.addMessage(currentRoomId, currentUser.name)}
