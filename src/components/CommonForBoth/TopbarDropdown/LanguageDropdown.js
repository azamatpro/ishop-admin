...
class LanguageDropdown extends Component {
  ...
  changeLanguageAction = (lng) => {
    ...
    else if (lng === 'kr') this.setState({ lng: 'Korean', flag: korea });
  };
        ...
        <Dropdown isOpen={this.state.menu} toggle={this.toggle} className='d-none d-sm-inline-block'>
          ...
          <DropdownMenu className='dropdown-menu-end'>
            ...
            <DropdownItem
              ...
              href=''
              onClick={() => this.changeLanguageAction('kr')}
              className='notify-item'
            >
              <img src={korea} alt='user' className='me-1' height='12' /> <span className='align-middle'>Korean</span>
            </DropdownItem>
